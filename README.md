...
| `/privacy` | View what data is stored and your data rights |
| `/delete_my_data` | Permanently delete your profile and all logs |
...
Drax stores health data (weight, meals, activity). Below is what you should know before deploying or using it.

### What data is stored

| Category | Data |
|---|---|
| Profile | Name, age, gender, height, current weight, goal weight, timezone |
| Daily logs | Meal descriptions + macros, water intake, workout completions, weight entries |
...
|---|---|
| **See your data** | `/progress` and `/report` show everything |
| **Delete everything** | `/delete_my_data` — permanent, immediate, irreversible |
| **Stop all notifications** | `/notifications` → Pause All |

### Regulatory framework

Drax is designed for personal use and follows the principles of:

| Framework | Scope | Key obligations met |
|---|---|---|
| **EU GDPR** (Reg. 2016/679) | EU/EEA users | Lawful basis (personal use / legitimate interest), right to erasure (Art. 17), data minimisation (Art. 5), transparency (Art. 13) |
| **UK GDPR** | UK users | Same as EU GDPR post-Brexit |
| **India DPDP Act 2023** | Indian users | Consent-based processing, right to erasure (S. 13), purpose limitation (S. 4) |
| **Canada PIPEDA** | Canadian users | Identifying purpose, consent, limited collection |
| **Australia Privacy Act 1988** | Australian users | Collection notice, access and correction rights |
| **US FTC Act / COPPA** | US users | No deceptive health claims; minimum age 13 (COPPA compliance — no users under 13) |

### Is Drax a medical device?

**No.** Drax is a general-purpose fitness and nutrition tracking tool. It is:

- **Not** a medical device under EU MDR 2017/745, US FDA 21 CFR, or equivalent national regulations
- **Not** a clinical decision support tool
- **Not** a substitute for professional medical, nutritional, or fitness advice

Drax does not diagnose, treat, cure, or prevent any disease or medical condition. Users with medical conditions should obtain clearance from a qualified healthcare professional before following any plan generated by Drax.

### Third-party data processors

When you use Drax, your data may be processed by:

| Service | What is sent | Their privacy policy |
|---|---|---|
| Telegram | All messages | [telegram.org/privacy](https://telegram.org/privacy) |
| Anthropic / OpenAI / DeepSeek | Meal descriptions, chat text | Provider's own policy |
| Nutritionix (optional) | Food descriptions for calorie lookup | [nutritionix.com/privacy](https://www.nutritionix.com/privacy-policy) |

You control which LLM provider is used via `LLM_PROVIDER` in `.env`. Nutritionix is entirely optional.
